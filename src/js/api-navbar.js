// Script para enlace API en navbar - Colombia
...
(function() {
  ...
  function addApiLink() {
    ...
    // Verificar si estamos en el sitio correcto (opcional, por ahora lo dejamos activo siempre)
    const path = window.location.pathname;
    const isColombia = true; // Habilitado para todo el sitio
    
    console.log('📍 Path:', path);
    console.log('✅ Es Colombia:', isColombia);
    
    if (!isColombia) {
      console.log('❌ No es Colombia, saliendo');
    ...
    // Apunta a la primera sección de la API
    apiLink.href = '/api/01-configuraciones-basicas/empresa/configurar-compania';
